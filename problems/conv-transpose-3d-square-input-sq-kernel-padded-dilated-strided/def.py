...
class conv_transpose_3d_square_input_sq_kernel_padded_dilated_strided(Problem):
    """ConvTranspose3D with square input, padding, dilation, and stride."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-3d-square-input-sq-kernel-padded-dilated-strided"
        )
