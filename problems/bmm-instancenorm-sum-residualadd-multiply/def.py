...
class bmm_instancenorm_sum_residualadd_multiply(Problem):
    """Linear projection then InstanceNorm, residual add, and multiply."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="bmm-instancenorm-sum-residualadd-multiply"
        )

    def reference_solution(self, input_tensor: torch.Tensor, residual: torch.Tensor,
        ...
        return [{
            ...
            "create_inputs": lambda seed=seed, dtype=dtype: (
                *(lambda g: (
                    ...
                    torch.rand(batch_size, out_features, device="cuda", dtype=dtype, generator=g),
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        ...
        return {
            ...
            "create_inputs": lambda: (
                ...
                torch.rand(batch_size, out_features, device="cuda", dtype=dtype),
