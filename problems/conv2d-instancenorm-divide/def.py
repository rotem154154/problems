...
class conv2d_instancenorm_divide(Problem):
    """Conv2D followed by InstanceNorm and divide."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="conv2d-instancenorm-divide"
        )
