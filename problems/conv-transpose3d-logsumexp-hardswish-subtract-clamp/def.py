...
class conv_transpose3d_logsumexp_hardswish_subtract_clamp(Problem):
    """ConvTranspose3D, logsumexp, hardswish, subtract, clamp."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="conv-transpose3d-logsumexp-hardswish-subtract-clamp"
        )

    def reference_solution(self, input_tensor: torch.Tensor, kernel: torch.Tensor, conv_bias: torch.Tensor,
                          subtract_bias: torch.Tensor, stride_d: int, stride_h: int, stride_w: int,
        ...
        return [{
            ...
            "create_inputs": lambda seed=seed, dtype=dtype: (
                *(lambda g: (
                    ...
                    torch.rand(1, 1, 1, 1, device="cuda", dtype=dtype, generator=g),
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        ...
        return {
            ...
            "create_inputs": lambda: (
                ...
                torch.zeros(1, 1, 1, 1, device="cuda", dtype=dtype),
            )
        }
    ...
    def get_function_signature(self) -> Dict[str, Any]:
        return {
            "argtypes": [
                ...
                ctypes.POINTER(ctypes.c_float),  # subtract_bias
