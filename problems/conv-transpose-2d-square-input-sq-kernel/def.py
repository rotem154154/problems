...
class conv_transpose_2d_square_input_sq_kernel(Problem):
    """ConvTranspose2D with square input and square kernel."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-2d-square-input-sq-kernel"
        )
