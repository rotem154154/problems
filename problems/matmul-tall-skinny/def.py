...
class matmul_tall_skinny(Problem):
    """Tall-skinny matrix multiplication problem."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="matmul-tall-skinny"
        )
    ...
    def generate_test_cases(self, dtype: torch.dtype) -> List[Dict[str, Any]]:
        """
        Generate test cases for tall-skinny matrix multiplication.
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        """
        Generate sample test case for tall-skinny matrix multiplication.
