...
class conv_3d_asym_input_sq_kernel(Problem):
    ...
    def __init__(self):
        super().__init__(
            name="conv-3d-asym-input-sq-kernel"
        )
    ...
    def generate_test_cases(self, dtype: torch.dtype) -> List[Dict[str, Any]]:
        ...
        return [{
            "name": f"B{batch_size} C{in_channels}->{out_channels} H{height} W{width} D{depth}",
            ...
            "create_inputs": lambda seed=seed, dtype=dtype: (
                *(lambda g: (
                    torch.rand(batch_size, in_channels, height, width, depth, device="cuda", dtype=dtype, generator=g),
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        ...
        return {
            ...
            "create_inputs": lambda: (
                torch.rand(batch_size, in_channels, height, width, depth, device="cuda", dtype=dtype),
