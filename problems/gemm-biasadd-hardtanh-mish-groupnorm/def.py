...
class gemm_biasadd_hardtanh_mish_groupnorm(Problem):
    """GEMM, bias add, hardtanh, mish, groupnorm."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="gemm-biasadd-hardtanh-mish-groupnorm"
        )

    def reference_solution(self, input_tensor: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor,
                          add_bias: torch.Tensor, gn_weight: torch.Tensor, gn_bias: torch.Tensor,
