...
class conv_2d_square_input_asym_kernel_dilated_padded(Problem):
    """2D convolution with square input, asymmetric kernel, dilation and padding."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-2d-square-input-asym-kernel-dilated-padded"
        )
