...
class matmul_small_k(Problem):
    """Matrix multiplication with small K dimension problem."""
    ...
    def generate_test_cases(self, dtype: torch.dtype) -> List[Dict[str, Any]]:
        """
        Generate test cases for matrix multiplication with small K.
        
        Returns:
            List of test case dictionaries with fixed dimensions
        """
        m, n, k = (16384 * 2, 16384 * 2, 32 * 2)
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        """
        Generate sample test case for matrix multiplication with small K.
