...
class conv3d_relu_leakyrelu_gelu_sigmoid_biasadd(Problem):
    """Conv3D followed by ReLU, LeakyReLU, GELU, Sigmoid, and bias add."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="conv3d-relu-leakyrelu-gelu-sigmoid-biasadd"
        )
