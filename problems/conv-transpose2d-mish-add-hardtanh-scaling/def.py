...
class conv_transpose2d_mish_add_hardtanh_scaling(Problem):
    """ConvTranspose2D followed by Mish, add, Hardtanh, and scaling."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="conv-transpose2d-mish-add-hardtanh-scaling"
        )
