...
class conv_transpose_2d_asym_input_asym_kernel_padded(Problem):
    """ConvTranspose2D with asymmetric input, asymmetric kernel, and padding."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-2d-asym-input-asym-kernel-padded"
        )
