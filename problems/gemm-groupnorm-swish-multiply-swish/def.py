...
class gemm_groupnorm_swish_multiply_swish(Problem):
    ...
    def __init__(self):
        super().__init__(
            name="gemm-groupnorm-swish-multiply-swish"
        )

    def reference_solution(self, input_tensor: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor,
                          gn_weight: torch.Tensor, gn_bias: torch.Tensor, multiply_weight: torch.Tensor,
    ...
    def get_function_signature(self) -> Dict[str, Any]:
        return {
            "argtypes": [
                ...
                ctypes.POINTER(ctypes.c_float),  # multiply_weight
