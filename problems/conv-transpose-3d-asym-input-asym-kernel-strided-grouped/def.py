...
class conv_transpose_3d_asym_input_asym_kernel_strided_grouped(Problem):
    """ConvTranspose3D with asymmetric input/kernel, stride, padding, output padding, groups."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-3d-asym-input-asym-kernel-strided-grouped"
        )
