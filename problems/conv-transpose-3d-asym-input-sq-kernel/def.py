...
class conv_transpose_3d_asym_input_sq_kernel(Problem):
    """ConvTranspose3D with asymmetric input and square kernel."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-3d-asym-input-sq-kernel"
        )
