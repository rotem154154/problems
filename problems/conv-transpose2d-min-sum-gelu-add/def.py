...
class conv_transpose2d_min_sum_gelu_add(Problem):
    """ConvTranspose2D then min, sum, GELU, and bias add."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="conv-transpose2d-min-sum-gelu-add"
        )
        ...
        return [{
            ...
            "create_inputs": lambda seed=seed, dtype=dtype: (
                *(lambda g: (
                    ...
                    torch.rand(1, 1, 1, device="cuda", dtype=dtype, generator=g),
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        ...
        return {
            ...
            "create_inputs": lambda: (
                ...
                torch.zeros(1, 1, 1, device="cuda", dtype=dtype),
            )
        }
