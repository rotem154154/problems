...
class conv_transpose_2d_asym_input_asym_kernel_strided_grouped(Problem):
    """ConvTranspose2D with asymmetric input, kernel, stride, dilation and groups."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-2d-asym-input-asym-kernel-strided-grouped"
        )
