...
class matmul_min_subtract(Problem):
    """Linear projection, min, subtract constant."""

    is_exact = False

    def __init__(self):
        super().__init__(
            name="matmul-min-subtract"
        )
        ...
        return [{
            ...
            "create_inputs": lambda seed=seed, dtype=dtype: (
                *(lambda g: (
                    ...
                    torch.tensor(constant_value, device="cuda", dtype=dtype),
    ...
    def get_function_signature(self) -> Dict[str, Any]:
        return {
            "argtypes": [
                ...
                ctypes.POINTER(ctypes.c_float),  # constant
