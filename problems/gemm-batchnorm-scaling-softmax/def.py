...
class gemm_batchnorm_scaling_softmax(Problem):
    ...
    def __init__(self):
        super().__init__(
            name="gemm-batchnorm-scaling-softmax"
        )

    def reference_solution(self, input_tensor: torch.Tensor, weight: torch.Tensor, bias: torch.Tensor,
                          bn_weight: torch.Tensor, bn_bias: torch.Tensor, scale: torch.Tensor) -> torch.Tensor:
