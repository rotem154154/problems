...
class conv_transpose_2d_asym_input_sq_kernel_dilated_padded_strided(Problem):
    """ConvTranspose2D with asymmetric input, square kernel, dilation, padding, stride."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="conv-transpose-2d-asym-input-sq-kernel-dilated-padded-strided"
        )
