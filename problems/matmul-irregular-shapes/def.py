...
class matmul_irregular_shapes(Problem):
    """Matrix multiplication with irregular shapes problem."""
    
    is_exact = False
    
    def __init__(self):
        super().__init__(
            name="matmul-irregular-shapes"
        )
    ...
    def generate_test_cases(self, dtype: torch.dtype) -> List[Dict[str, Any]]:
        """
        Generate test cases for matrix multiplication with irregular shapes.
    ...
    def generate_sample(self, dtype: torch.dtype = torch.float32) -> Dict[str, Any]:
        """
        Generate sample test case for matrix multiplication with irregular shapes.
